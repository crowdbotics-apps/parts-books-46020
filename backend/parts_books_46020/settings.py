"""
Django settings for parts_books_46020 project.
...
ROOT_URLCONF = 'parts_books_46020.urls'
...
WSGI_APPLICATION = 'parts_books_46020.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "parts_books_46020 API",
    "DESCRIPTION": "API documentation for parts_books_46020 App",
    "VERSION": "v1",
}
